...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'surgeworks.email_manager' => 'getSurgeworks_EmailManagerService',
            'surgeworks.logout_success_handler' => 'getSurgeworks_LogoutSuccessHandlerService',
            'surgeworks.news_manager' => 'getSurgeworks_NewsManagerService',
            'surgeworks.security_listener' => 'getSurgeworks_SecurityListenerService',
            'surgeworks.user_manager' => 'getSurgeworks_UserManagerService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/Workouts/User-Login-Sytem-With-Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/Workouts/User-Login-Sytem-With-Symfony/app/Resources');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('security.interactive_login', array(0 => 'surgeworks.security_listener', 1 => 'onSecurityInteractiveLogin'), 0);
        $instance->addListenerService('kernel.response', array(0 => 'surgeworks.security_listener', 1 => 'onKernelResponse'), 0);
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_19e5de1157351d0035a7472952c46f6594299610318bf865f7af5df11443a73a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_19e5de1157351d0035a7472952c46f6594299610318bf865f7af5df11443a73a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_19e5de1157351d0035a7472952c46f6594299610318bf865f7af5df11443a73a');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => 'F:\\Workouts\\User-Login-Sytem-With-Symfony\\src\\Surgeworks\\CoreBundle\\Entity')), 'Surgeworks\\CoreBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('SurgeworksCoreBundle' => 'Surgeworks\\CoreBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/Workouts/User-Login-Sytem-With-Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('F:/Workouts/User-Login-Sytem-With-Symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Surgeworks\\CoreBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $d, $this->get('surgeworks.logout_success_handler'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'logout'));
        $i->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $j = new \Surgeworks\CoreBundle\Component\Authentication\Handler\AuthenticationHandler($e, $f, $a);

        $k = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($h, $d, '/login', false);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.main')), 'secured_area', $b, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $j, $j, array('require_previous_session' => false, 'check_path' => 'login_check', 'use_forward' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $g, 'secured_area', $k, $b), 5 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', $k, NULL, NULL, $b));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('F:/Workouts/User-Login-Sytem-With-Symfony/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'surgeworks.email_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Surgeworks\CoreBundle\Services\EmailManager A Surgeworks\CoreBundle\Services\EmailManager instance.
     */
    protected function getSurgeworks_EmailManagerService()
    {
        return $this->services['surgeworks.email_manager'] = new \Surgeworks\CoreBundle\Services\EmailManager($this, array('username' => 'username', 'password' => 'password'));
    }

    /**
     * Gets the 'surgeworks.logout_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Surgeworks\CoreBundle\Component\Authentication\Handler\LogoutSuccessHandler A Surgeworks\CoreBundle\Component\Authentication\Handler\LogoutSuccessHandler instance.
     */
    protected function getSurgeworks_LogoutSuccessHandlerService()
    {
        return $this->services['surgeworks.logout_success_handler'] = new \Surgeworks\CoreBundle\Component\Authentication\Handler\LogoutSuccessHandler();
    }

    /**
     * Gets the 'surgeworks.news_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Surgeworks\CoreBundle\Services\NewsManager A Surgeworks\CoreBundle\Services\NewsManager instance.
     */
    protected function getSurgeworks_NewsManagerService()
    {
        return $this->services['surgeworks.news_manager'] = new \Surgeworks\CoreBundle\Services\NewsManager('http://news.google.com/?output=rss');
    }

    /**
     * Gets the 'surgeworks.security_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Surgeworks\CoreBundle\Listeners\SecurityListener A Surgeworks\CoreBundle\Listeners\SecurityListener instance.
     */
    protected function getSurgeworks_SecurityListenerService()
    {
        return $this->services['surgeworks.security_listener'] = new \Surgeworks\CoreBundle\Listeners\SecurityListener($this->get('router'));
    }

    /**
     * Gets the 'surgeworks.user_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Surgeworks\CoreBundle\Services\UserManager A Surgeworks\CoreBundle\Services\UserManager instance.
     */
    protected function getSurgeworks_UserManagerService()
    {
        return $this->services['surgeworks.user_manager'] = new \Surgeworks\CoreBundle\Services\UserManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/Workouts/User-Login-Sytem-With-Symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/Workouts/User-Login-Sytem-With-Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\src\\Surgeworks\\CoreBundle/Resources/views', 'SurgeworksCore');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('F:/Workouts/User-Login-Sytem-With-Symfony/app/Resources/views');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'F:\\Workouts\\User-Login-Sytem-With-Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/Workouts/User-Login-Sytem-With-Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_ADMIN', 2 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Surgeworks\\CoreBundle\\Entity\\User', 'username', NULL);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev',
            'kernel.logs_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/logs',
            'kernel.bundles' => array(
                ...
                'SurgeworksCoreBundle' => 'Surgeworks\\CoreBundle\\SurgeworksCoreBundle',
            ...
            'debug.container.dump' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/../web',
            'assetic.write_to' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/app/cache/dev/doctrine/orm/Proxies',
