...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/Resources');
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'db', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_04ee556a471a800aa817f4d5387519a99a72f7d4ec7332ce16a5a4f3be63b011');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_04ee556a471a800aa817f4d5387519a99a72f7d4ec7332ce16a5a4f3be63b011');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_04ee556a471a800aa817f4d5387519a99a72f7d4ec7332ce16a5a4f3be63b011');
        ...
        $d->setProxyDir('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\src\\Profile\\Bundle/Resources/views', 'Profile');
        $instance->addPath('F:/Workouts/User-Login-Sytem-With-Symfony/path/app/Resources/views');
        $instance->addPath('F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => 'F:\\Workouts\\User-Login-Sytem-With-Symfony\\path\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/../web', false);
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('542c3792395f4')), true);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod');
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod',
            'kernel.logs_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/logs',
            'kernel.bundles' => array(
                ...
                'ProfileBundle' => 'Profile\\Bundle\\ProfileBundle',
            ),
            ...
            'session.save_path' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/sessions',
            ...
            'router.resource' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/../web',
            'assetic.write_to' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'F:/Workouts/User-Login-Sytem-With-Symfony/path/app/cache/prod/doctrine/orm/Proxies',
